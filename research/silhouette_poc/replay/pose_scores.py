...
should be quoted as an accuracy figure. ``tests/test_pose_scores.py`` shows
...
from .fit_real import iou as _iou, render_mask_6dof, triad
...
class Pose:
    ...
    Angles follow ``fit_real.triad``: yaw about world up is FACE ANGLE, pitch
