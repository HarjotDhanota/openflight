...
- **A9 — Missed prior art.** Search for existing open-source golf club/head segmentation or pose models (the spec claims none exist at this vantage) and any published OERT/silhouette-fusion detail (patents US10393870, Trackman OERT materials) that changes §5. Start from the pre-seeded survey in `2026-08-22-silhouette-poc-tools-survey.md`; verify its license claims and adopt/reject each 'Adopt' row explicitly.
